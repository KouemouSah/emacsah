        ...
        <div className="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8">
          ...
          {project.context_fr && (
            <div className="mb-12">
              ...
              <div className="prose prose-slate max-w-none">
                {typeof project.context_fr === 'string' ? (
                  <p>{project.context_fr}</p>
                ) : (
                  <div dangerouslySetInnerHTML={{ __html: JSON.stringify(project.context_fr) }} />
                )}
              </div>
            </div>
          )}
          ...
          {project.challenges_fr && (
            <div className="mb-12">
              ...
              <div className="prose prose-slate max-w-none">
                {typeof project.challenges_fr === 'string' ? (
                  <p>{project.challenges_fr}</p>
                ) : (
                  <div dangerouslySetInnerHTML={{ __html: JSON.stringify(project.challenges_fr) }} />
                )}
              </div>
            </div>
          )}
          ...
          {project.solution_fr && (
            <div className="mb-12">
              ...
              <div className="prose prose-slate max-w-none">
                {typeof project.solution_fr === 'string' ? (
                  <p>{project.solution_fr}</p>
                ) : (
                  <div dangerouslySetInnerHTML={{ __html: JSON.stringify(project.solution_fr) }} />
                )}
              </div>
            </div>
          )}
          ...
          {project.results_fr && (
            <div className="mb-12">
              ...
              <div className="prose prose-slate max-w-none">
                {typeof project.results_fr === 'string' ? (
                  <p>{project.results_fr}</p>
                ) : (
                  <div dangerouslySetInnerHTML={{ __html: JSON.stringify(project.results_fr) }} />
                )}
              </div>
            </div>
          )}
