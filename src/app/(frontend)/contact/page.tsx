      ...
      <section className="py-16">
        <div className="mx-auto max-w-2xl px-4 sm:px-6 lg:px-8">
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div>
                  ...
                  <textarea
                    ...
                    required
                    rows={6}
                    className="w-full px-4 py-3 border border-slate-300 rounded-lg focus:ring-2 focus:ring-violet-500 focus:border-violet-500 transition-colors resize-none"
                ...
                <button
                  ...
                  className="w-full py-4 px-6 bg-gradient-to-r from-violet-600 to-purple-600 text-white font-semibold rounded-lg hover:from-violet-700 hover:to-purple-700 focus:ring-2 focus:ring-violet-500 focus:ring-offset-2 transition-all disabled:opacity-50 disabled:cursor-not-allowed"
                >
                  {status === 'loading' ? (
          ...
          <div className="mt-12 text-center">
            <p className="text-slate-500 mb-4">Vous pouvez également me contacter sur</p>
            <div className="flex items-center justify-center gap-6">
              <a
                href="https://github.com/emacsah"
                target="_blank"
              ...
              <a
                href="https://linkedin.com/in/emacsah"
                target="_blank"
                rel="noopener noreferrer"
                className="flex items-center gap-2 text-slate-600 hover:text-violet-600 transition-colors"
              >
